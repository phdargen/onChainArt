...
import { Container, Button, makeStyles, Typography, Grid , Link} from "@material-ui/core"
...
export const Footer = () => {
    ...
    return (
        ...
        <Grid className={classes.grid} container spacing={0}>
            <Grid item xs={4} >
                <Typography variant="h5" className={classes.title}> LICENSE </Typography>
                <p></p>
                <Typography variant="subtitle1" className={classes.title}> NFT License 2.0 </Typography>
            </Grid>
            ...
            <Grid item xs={1}  className={classes.gridItem} >
                <Link className={classes.icon} href={openSeaLink}>
                    <svg width="50" height="50" viewBox="-10 -10 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Grid item xs={4} >
                ...
                <p></p>
                <Typography variant="subtitle1" className={classes.title}> This project is in beta. Use at your own risk.</Typography>
            </Grid>

            <Grid item xs={12}  >
                <Typography variant="subtitle1" className={classes.title}> <Copyright/> </Typography>
            </Grid>
