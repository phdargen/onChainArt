            ...
            <Container className={classes.container} maxWidth="lg">
                ...
                <Grid className={classes.grid} container spacing={0}>
                    ...
                    <Grid item className={classes.gridItem} xs={1}  >
                        <Link className={classes.icon} href={twitterLink} target="_blank"  rel="noopener noreferrer">
                            <FontAwesomeIcon icon={faTwitterSquare} size="3x" />
                        </Link>
                    </Grid>
                    <Grid item xs={1} className={classes.gridItem} >
                        <Link className={classes.icon} href={openSeaLink} target="_blank"  rel="noopener noreferrer"> 
                    ...
                    <Grid item className={classes.gridItem} xs={1}  >
                        <Link className={classes.icon} href={gitLink} target="_blank"  rel="noopener noreferrer">
